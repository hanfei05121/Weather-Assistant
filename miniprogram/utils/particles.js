...
exports.WeatherParticles = void 0;
...
class WeatherParticles {
    ...
    setWeather(code) {
        ...
        if (next === this.kind && this.particles.length > 0)
            return;
        this.kind = next;
        this.flashUntil = 0;
        this.nextFlash = 0;
    ...
    spawn() {
        ...
        const base = { kind: k, x: rnd() * w, y: rnd() * h, vx: 0, vy: 0, size: 2, phase: rnd() * TWO_PI, speed: 1, alpha: 1 };
        switch (k) {
            case 'rain':
...
exports.WeatherParticles = WeatherParticles;
